...
strcat(first_name, a.first_name);
strcat(last_name, a.last_name);
strcat(phone_number, a.phone_number);
return *this;
}
...
operator Person(){
Person a;
a.set_last_name(this->get_last_name());
a.set_first_name(this->get_first_name());
a.set_phone_number(this->get_phone_number());
return a;
}
...
Department(int i, char * s): amount(i) {
abv = new char [strlen(s)+1];
...
void printsdep(){
cout<<abv<<" "<<amount<<" ";
for(int i=0;i<amount;i++){students[i].printp();cout<<endl;}
}
...
void Rabotyaga :: printp(){

cout<<"Rabotyaga"<<" "<<position<<" "<<salary<<" "<<experience;
}
/////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
Student::Student(){
...
void Student :: printp(){
Person::printp();
cout<<"Student"<<" "<<group<<" "<<course<<" "<<rate<<" "<<count1;
}
...
// Avram++;
// Avram.printp();
// Student Yakovenko("KA-81", 10, 100 );
...
//// cin>>Arsen;
//// cout<<Arsen;
// Department MMSA(1,"kk");
// MMSA[0] = Yakovenko;
// MMSA.printsdep();
// cout<<"////////////////////////////////////////////"<<endl;
// Person obj3("33","44","33", 1,1,1), obj4("33","44","33",1,1,1);
// Yakovenko.set_last_name("YOOOOUUU");
// Person obj5;
// obj5=obj3+Yakovenko;
// obj5.printp();
// cout<<"////////////////////////////////////////////"<<endl;
